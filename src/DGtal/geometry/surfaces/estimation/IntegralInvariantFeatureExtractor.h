...
/**
 * @file IntegralInvariantFeatureExtractor.h
 ...
 * @date 2014/04/24
 *
 * Header file for module IntegralInvariantFeatureExtractor.ih
 *
 * This file is part of the DGtal library.
 */

#if defined(IntegralInvariantFeatureExtractor_RECURSES)
#error Recursive header files inclusion detected in IntegralInvariantFeatureExtractor.h
#else // defined(IntegralInvariantFeatureExtractor_RECURSES)
/** Prevents recursive inclusion of headers. */
#define IntegralInvariantFeatureExtractor_RECURSES

#if !defined IntegralInvariantFeatureExtractor_h
/** Prevents repeated inclusion of headers. */
#define IntegralInvariantFeatureExtractor_h
...
#include "DGtal/geometry/surface/IntegralInvariantVolumeEstimator.h"
#include "DGtal/geometry/surface/IntegralInvariantCovarianceEstimator.h"
...
/////////////////////////////////////////////////////////////////////////////
// template class IntegralInvariantFeatureExtractor
/**
* Description of template class 'IntegralInvariantFeatureExtractor' <p>
...
* function.
*
* @tparam TFunctor a model of functor Real -> Quantity, that
...
*
* @see testIntegralInvariantFeatureExtractor.cpp
*/
template <typename TKSpace, typename TPointPredicate, typename TEstimator, typename TFunctor>
class IntegralInvariantFeatureExtractor
{
public:
  typedef IntegralInvariantFeatureExtractor< TKSpace, TPointPredicate, TEstimator, TFunctor> Self;
  ...
  typedef typename Functor::Quantity Quantity;

  typedef typename Estimator<TKSpace, TPointPredicate, TFunctor> curvatureEstimator;
  ...
  // BOOST_CONCEPT_ASSERT (( concepts::CUnaryFunctor< Functor, Component, Quantity > ));
  // BOOST_STATIC_ASSERT (( concepts::ConceptUtils::SameType< typename Convolver::Quantity,
  //                                                typename Functor::Argument >::value ));
...
public:
  ...
  */
  IntegralInvariantFeatureExtractor( CurvatureEstimator est = CurvatureEstimator() );
  ...
  * some quantity. If not precised, a default object is instantiated.
  */
  IntegralInvariantFeatureExtractor ( ConstAlias< KSpace > K,
                                     ConstAlias< PointPredicate > aPointPredicate,
                                     CurvatureEstimator est = CurvatureEstimator() );

  /**
  * Destructor.
  */
  ~IntegralInvariantFeatureExtractor();

  /**
  * Copy constructor.
  * @param other the object to clone.
  */
  IntegralInvariantFeatureExtractor ( const Self& other );
...
public:
  ...
  */
  void setParams( const double dRadiusMin,
                  const double dRadiusMax,
                  const double dStep );
  ...
  * a shape, then apply the Functor to extract some
  ...
  * Functor to extract some geometric information.
...
private:
  ...
  Functor myFct;            ///< The volume functor that transforms the volume into a quantity.
...
}; // end of class IntegralInvariantFeatureExtractor

  /**
  * Overloads 'operator<<' for displaying objects of class 'IntegralInvariantFeatureExtractor'.
  * @param out the output stream where the object is written.
  * @param object the object of class 'IntegralInvariantFeatureExtractor' to write.
  * @return the output stream after the writing.
  */
  template <typename TKSpace, typename TPointPredicate, typename TFunctor>
  std::ostream&
  operator<< ( std::ostream & out,
               const IntegralInvariantFeatureExtractor<TKSpace, TPointPredicate, TFunctor> & object );
...
#include "DGtal/geometry/surfaces/estimation/IntegralInvariantFeatureExtractor.ih"

//                                                                           //
///////////////////////////////////////////////////////////////////////////////

#endif // !defined IntegralInvariantFeatureExtractor_h

#undef IntegralInvariantFeatureExtractor_RECURSES
#endif // else defined(IntegralInvariantFeatureExtractor_RECURSES)
