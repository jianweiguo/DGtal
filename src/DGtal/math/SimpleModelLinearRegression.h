...
/**
 * @file SimpleModelLinearRegression.h
 ...
 * @date 2011/06/24
 *
 * Header file for module SimpleModelLinearRegression
 *
 * This file is part of the DGtal library.
 */

#if defined(SimpleModelLinearRegression_RECURSES)
#error Recursive header files inclusion detected in SimpleModelLinearRegression.h
#else // defined(SimpleModelLinearRegression_RECURSES)
/** Prevents recursive inclusion of headers. */
#define SimpleModelLinearRegression_RECURSES

#if !defined SimpleModelLinearRegression_h
/** Prevents repeated inclusion of headers. */
#define SimpleModelLinearRegression_h
...
namespace DGtal
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  // class SimpleModelLinearRegression
  /////////////////////////////////////////////////////////////////////////////
  /**
   * @brief Description of class 'SimpleModelLinearRegression'
   *
   * Aim:
...
//    double mySumXY;
  ...
  private:
     ...
     */
    SimpleModelLinearRegression( const SimpleModelLinearRegression & other );
     ...
     * Forbidden by default.
     */
     SimpleModelLinearRegression & operator=( const SimpleModelLinearRegression & other );
  ...
  /**
   * Overloads 'operator<<' for displaying objects of class 'SimpleModelLinearRegression'.
   * @param that_stream the output stream where the object is written.
   * @param that_object_to_display the object of class 'SimpleModelLinearRegression' to write.
   * @return the output stream after the writing.
   */
  std::ostream&
  operator<<( std::ostream & that_stream,
        const SimpleModelLinearRegression & that_object_to_display );
...
#include "DGtal/math/SimpleModelLinearRegression.ih"

//                                                                           //
///////////////////////////////////////////////////////////////////////////////

#endif // !defined SimpleModelLinearRegression_h

#undef SimpleModelLinearRegression_RECURSES
#endif // else defined(SimpleModelLinearRegression_RECURSES)
